...
from car_wash.utils import Singleton


DB_CONFIG = {'hostname': 'localhost',
            .......} # all other DB params should be here
...
class DBPoolBase(metaclass=Singleton):
    ...
    def __enter__(self):
        ...
        raise NotImplementedError('No code added into __enter__ method')
    
    def __exit__(self):
        """Method to get the db connection."""
        raise NotImplementedError('No code added into __exit__ method')
